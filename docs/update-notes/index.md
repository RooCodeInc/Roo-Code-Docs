...
If you want to live on the edge and try things out before released, we have a [Nightly channel](https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-code-nightly).
