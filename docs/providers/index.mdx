...
We recurringly run evals for all supported models to see how they do against our standard test suite. [See the latest results here](https://roocode.com/evals).
