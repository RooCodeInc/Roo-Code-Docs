...
If you have a file-based custom system prompt (`.roo/system-prompt-{modeSlug}`), it replaces the standard system prompt entirely—including the skills section. Skills won't be available when a custom system prompt is active.
:::
