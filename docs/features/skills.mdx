...
<div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
  <iframe
    src="https://www.youtube.com/embed/cK2CBU54bhw"
    style={{
      position: 'absolute',
      top: 0,
      left: 0,
...
If you have a file-based custom system prompt (`.roo/system-prompt-{mode}` or similar), it replaces the standard system prompt entirely—including the skills section. Skills won't be available when a custom system prompt is active.
:::
...
Roo Code skills follow the [Agent Skills](https://agentskills.io/) format for skill packaging and metadata.
