...
This allows you to share Roo Code tasks (in the extension or from Cloud Agents) with secure links with whoever you choose. This allwos you to hlep others understand how you're using Roo, debug a problem or help ypour teammates learn.
